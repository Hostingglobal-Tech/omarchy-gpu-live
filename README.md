...
남의 GPU 기계 앞에서 시간을 버리는 것이 싫어서입니다.

Omarchy 자체는 훌륭합니다. 다만 그것은 **설치해서 쓰는 데스크톱**을 상정하고 만들어져,
"USB 로 들고 다니며 남의 GPU 기계에 꽂는다" 는 쓰임새에서는 몇 가지가 걸립니다.
...
원래 Omarchy 에는 한글 **폰트만** 있고 입력기가 없습니다. 글자가 보이기는 하는데
**칠 수가 없습니다.**

AI-OS 는 `fcitx5-hangul` 을 넣고 데스크톱이 뜰 때 자동으로 켜지게 했습니다.
한/영 전환은 평소 쓰던 대로 됩니다.
